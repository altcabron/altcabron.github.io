<script>
    import socials from "@data/footer.json"
</script>

<div class="bg-black text-cream footer transition duration-300">
    <nav class="container flex justify-between items-center max-w-screen-lg mx-auto py-20 gap-16">
        <div class="flex flex-col h-36 justify-between">
            <h2 class="text-header eiko font-black">Guido.</h2>
            <p class="objectsans"> 
                © 2025 Guido de Vries. ALL RIGHTS RESERVED.
            </p>
        </div>
